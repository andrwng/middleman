...
func (r *SessionRunner) runTurn(
	...
	mcpToolNames := "mcp__middleman__list_threads,mcp__middleman__get_thread,mcp__middleman__reply_to_thread,mcp__middleman__start_thread,mcp__middleman__list_repos"
	if in.MCP != nil {
